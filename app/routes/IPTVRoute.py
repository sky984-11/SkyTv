...
#EXTINF:-1 tvg-id="heilongjiang" tvg-logo="heilongjiang.png",黑龙江卫视
...
#EXTINF:-1 tvg-id="jiangsu" tvg-logo="jiangsu.png",江苏卫视
...
#EXTINF:-1 tvg-id="sdetv" tvg-logo="sdetv.png",山东教育电视台
...
#EXTINF:-1 tvg-id="travel" tvg-logo="travel.png",海南卫视
http://ottrrs.hl.chinamobile.com/PLTV/88888888/224/3221226465/index.m3u8

#EXTINF:-1 tvg-id="xiamen" tvg-logo="xiamen.png",厦门卫视
...
#EXTINF:-1 tvg-id="xizang" tvg-logo="xizang.png",西藏卫视
http://ottrrs.hl.chinamobile.com/PLTV/88888888/224/3221225638/index.m3u8

#EXTINF:-1 tvg-id="yanbian" tvg-logo="yanbian.png",延边卫视
...
def get_url_by_id(id):
    matches = re.findall(r'#EXTINF:.*tvg-id="(.*?)".*?\n(https?://[^#\n]+index\.m3u8)', m3u8_data)
    # 创建字典，键为id，值为M3U8链接
    m3u8_dict = {id: link for id, link in matches}
    return  jsonify({"code": 200, "result": m3u8_dict.get(id)}), 200